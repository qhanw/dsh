...
import { X, Home, Film, Tv, Play, Newspaper, Trophy, ChevronRight } from 'lucide-react';
...
export function SideNavigation({ isOpen, onClose }: SideNavigationProps) {
  ...
  return (
    <>
      ...
      {/* 侧边菜单 */}
      <div className={`fixed top-0 left-0 h-full w-80 bg-white shadow-xl z-50 transform transition-transform duration-300 ease-in-out lg:hidden flex flex-col ${
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200 flex-shrink-0">
          <div className="flex items-center space-x-3">
            ...
            {/* 标题 */}
            <span className="text-lg font-semibold text-gray-800">乡村电影</span>
          </div>
          {/* 关闭按钮 */}
          <button
            onClick={onClose}
